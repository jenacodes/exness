...
export const cryptoCards = [
  {
    imgSrc:
      "https://d33vw3iu5hs0zi.cloudfront.net/media/instant_withdrawals_96c97dca73.svg",
    imgAlt: "Instant withdrawals icon",
  ...
  {
    imgSrc:
      "https://d33vw3iu5hs0zi.cloudfront.net/media/exness_swap_free_5ad242f7c9.svg",
    imgAlt: "Mobile platforms icon",
    title: "Mobile platforms",
    description:
      "Whether you prefer the MetaTrader mobile app or Exness Trade App, your demo trading experience is streamlined and efficient with all the Exness benefits and features.",
  },
  {
    imgSrc:
    ...
    description:
      "Benefit from advanced stop out protection features designed to help manage risk and protect your trading account.",
  },
];
